            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        <form>
                            <div class="row">
                                <div class="col-md-5">
                                    <base-input type="text" label="Tên sự kiện" :disabled="true"
                                        placeholder="Light dashboard" v-model="eventInfo.eventName">
                                    </base-input>
                                </div>
                                <div class="col-md-3">
                                    <base-input type="text" label="Nhà cung cấp" placeholder="Username"
                                        v-model="eventInfo.supllier">
                                    </base-input>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <br>
                                    <img style="max-width: 780px;" slot="image"
                                        :src="$fileUrl+eventInfo.eventImage"
                                        alt="..." />
                                    <br>
                    ...
                    <card  v-for="item in eventInfo.eventDetails">
                        <div class="row">
                                <div class="col-md-4">
                                    <base-input type="text" label="Ngày diễn ra" :disabled="true"
                                    ...
                                    <base-input type="text" label="Địa điểm" placeholder="Username"
                                ...
                                <div class="col-md-8">
                                    ...
                                    <br>
                                    <img style="max-width: 780px;" slot="image"
                                        :src="$fileUrl+item.eventSeatMapImage"
                                        alt="..." />
                                    <br>
                                    <div style="display: flex; margin: 10px;">
                                        <div style="margin: auto;">
