...
namespace MYTICKET.BASE.InfrastructureBase.Persistence
{
    public class ApplicationDbContext<TUser> : DbContext where TUser : class, IUser
    {
        ...
        private void CheckAudit()
        {
            ...
            modified.ForAll(entity =>
            {
                ...
                if (entity is ISoftDelted softDeltedEntity && softDeltedEntity.Deleted && softDeltedEntity.DeletedBy == null)
                {
                    softDeltedEntity.DeletedDate = DateTime.Now;
                    softDeltedEntity.DeletedBy = UserId;
                }
            });
        }
