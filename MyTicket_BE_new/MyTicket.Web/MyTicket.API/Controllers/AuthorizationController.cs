...
using MYTICKET.BASE.IdentityServer.Controllers;
using MYTICKET.BASE.IdentityServer.Dto;
...
namespace MYTICKET.WEB.API.Controllers
{
    ...
    public class AuthorizationController : AuthorizationControllerBase
    {
        ...
        private void SetClaims(ClaimsIdentity identity, User user)
        {
            ...
            {
                identity.SetClaim(UserClaimTypes.CustomerId, user.CustomerId);
            }
            if (user.SupplierId is not null)
            {
                identity.SetClaim(UserClaimTypes.SupplierId, user.SupplierId);
            }
        }
