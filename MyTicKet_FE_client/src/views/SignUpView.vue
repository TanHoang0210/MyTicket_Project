        ...
        <div class="login-form">
          ...
          <b-form @submit="onSubmit" class="login-form--inner">
            <b-form-group id="email">
              <b-form-label class="input-label-login" label-for="email">Email</b-form-label>
            ...
            <b-form-group id="confirmPassword">
              <b-form-label class="input-label-login" label-for="confirmPassword">Nhập Lại Mật Khẩu</b-form-label>
              <div class="input-password">
