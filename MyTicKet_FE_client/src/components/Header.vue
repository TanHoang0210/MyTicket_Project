                ...
                <div class="language-control--item">
                    ...
                    <div class="language-choice">
                        <div class="language-choice--item" v-for="(localData, index) in localizations" :id="index"
                            :key="localData" v-on:click="myLanguage(localData, index)"
                            v-bind:class="{ active: index == isActive }">
                            <img class="language-type language-type-item" :src="localData.flagImg" alt="">
            ...
            <div class="left-header">
                ...
                <div class="header-search">
                    <div class="header-search--item">
                        ...
                        <b-form-input class="header-search--input" v-model="text"
                            placeholder="Tìm Kiếm Sự kiện"></b-form-input>
                    </div>
                </div>
                    ...
                    <div v-if="currentUser" class="user-info">
                        ...
                        <div class="user-action">
                            <ul class="user-action-list">
                                ...
                                <li class="user-action-item" style="display: flex;">
                                    <button v-on:click="logout()" class="user-logout">
                                        <b-icon style="margin-right: 5px;" icon="power"></b-icon>
                                        Đăng xuất
                                    </button>
                                </li>
                            </ul>
