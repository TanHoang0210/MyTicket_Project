<template>
    <section id="eventRefund" class="bg-grey box-shadow pb-4 pt-3 section-content">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 mgt-24"></div>
                ...
                <div id="eventfaq-content">
                    <ol>
                        ...
                        <li>Người giữ vé chịu mọi rủi ro về thương tích và mọi trách nhiệm đối với việc mất mát, phá hủy
                            hoặc trộm cắp tài sản và miễn trách nhiệm cho người quảng bá, người biểu diễn, nhà tài trợ, cửa
                            hàng bán vé, địa điểm và nhân viên của họ sau đó.</li>
